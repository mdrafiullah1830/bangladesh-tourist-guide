...
function getMockWeather(locationName: string): WeatherInfo {
  return {
    ...
    windSpeed: 12,
    forecast: [
      { date: "2026-08-29", tempMax: 32, tempMin: 26, description: "Partly cloudy", icon: "⛅", precipitation: 2 },
      { date: "2026-08-30", tempMax: 31, tempMin: 25, description: "Rain showers", icon: "🌦️", precipitation: 8 },
      { date: "2026-08-31", tempMax: 30, tempMin: 25, description: "Thunderstorm", icon: "⛈️", precipitation: 15 },
      { date: "2026-09-01", tempMax: 29, tempMin: 24, description: "Moderate rain", icon: "🌧️", precipitation: 12 },
      { date: "2026-09-02", tempMax: 31, tempMin: 25, description: "Partly cloudy", icon: "⛅", precipitation: 3 },
      { date: "2026-09-03", tempMax: 32, tempMin: 26, description: "Mainly clear", icon: "☀️", precipitation: 0 },
      { date: "2026-09-04", tempMax: 33, tempMin: 26, description: "Clear sky", icon: "☀️", precipitation: 0 },
    ],
